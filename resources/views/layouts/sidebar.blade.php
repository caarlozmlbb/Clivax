            ...
            <ul class="left-menu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('lista_usuarios') }}"><i
                                    class="mdi mdi-checkbox-blank-circle align-middle"></i> Lista de Usuarios</a></li>
                        <li><a href="{{ route('roles.index') }}"><i
                                    class="mdi mdi-checkbox-blank-circle align-middle"></i> Roles y Permisos</a></li>
                    </ul>
                </li>
